...
Minimal `ai-cdl` binary and typed config API for manifest generation and deterministic deployment
packaging. Pair uses this package to generate its development and production Office manifests.
